...
namespace AirFishLab.ScrollingList.BoxTransformCtrl
{
    public class LinearBoxTransformCtrl : IBoxTransformCtrl
    {
        ...
        private RangeMappingCurve _rotationCurve;
        ...
        public LinearBoxTransformCtrl(
            ...
            AnimationCurve boxRotationCurve,
        ...
        private float GetRotationValue(float majorPosition)
        {
            return _rotationCurve.Evaluate(majorPosition);
        }
            ...
            Transform boxTransform, int boxID, int numOfBoxes)
        {
            ...
            boxTransform.localPosition =
                _getLocalPosition(majorPosition, localPosition.y, passivePosition);
            ...
            var rotationValue = GetRotationValue(majorPosition);
            var localRotation = boxTransform.localRotation.eulerAngles;

            localRotation.y = rotationValue;    // According to your demands
 
            boxTransform.localRotation = Quaternion.Euler(0,rotationValue,0);
        }
